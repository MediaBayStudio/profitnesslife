...
// Создание новых колонок для products
...
// Заполнение колонок нужными данными
add_action( 'manage_product_posts_custom_column', function( $colname, $post_id ) {
  switch ( $colname ) {
    case 'calories':
      echo get_field( 'calories', $post_id );
      break;
...
add_filter( 'manage_edit-product_sortable_columns', 'sort_columns_by_calories' );
