...
<section class="user-data">
  ...
  <div class="user-data__current-weight">
    ...
    <span class="user-data__current-weight-number" id="current-weight-number"><?php echo $current_weight ?> кг</span>
  </div>
  <div class="user-data__weight-goal">
    ...
    <div class="user-data__weight-goal-chart">
      <div class="user-data__weight-goal-numbers">
        ...
        /
        <span class="user-data__weight-goal-total" id="weight-goal-total"><?php echo abs( $user_data['start_weight'] - $user_data['target_weight'] ) ?></span>
      </div>
    </div>
  </div>
