<section class="index-payment container sect"<?php echo $section_id ?>>
    ...
    foreach ( $section['payment_methods'] as $payment_method ) : ?>
      <li class="index-payment__method"> <?php
        if ( $payment_method['img'] ) :
          ...
          <img src="#" alt="<?php echo $alt ?>" data-src="<?php echo $payment_method['img']['url'] ?>" class="index-payment__method-img lazy"> <?php
        endif;
