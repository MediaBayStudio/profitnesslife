<section class="photo-progress-sect">
  ...
  <div class="photo-progress-slider" id="photo-progress-slider">
    <form action="<?php echo $site_url ?>/wp-admin/admin-ajax.php" name="photo-progress-form" class="photo-progress-form">
      <input type="file" name="photo" class="photo-progress-add">
    </form> <?php
