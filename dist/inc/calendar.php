...
class Calendar 
{
  public static function getMonth( $month, $year, $events = [] )
  {
    ...
    <div class="calendar-item">
      ...
      <table class="calendar-table">
        <tr class="calendar-hdr-row">
          <th class="calendar-hdr-cell">Пн</th>
          <th class="calendar-hdr-cell">Вт</th>
          <th class="calendar-hdr-cell">Ср</th>
          <th class="calendar-hdr-cell">Чт</th>
          <th class="calendar-hdr-cell">Пт</th>
          <th class="calendar-hdr-cell">Сб</th>
          <th class="calendar-hdr-cell">Вс</th>
        </tr>';
    ...
    for ( $day = 1; $day <= $days_month; $day++ ) {
      ...
      if ( $event_show ) {
        ...
        $out.= '<td class="calendar-day' . $class . '" ' . $day_date . '>' . $day . '</td>';
      }
   ...
   */
  public static function  getInterval( $start, $end, $events = [] )
  {
